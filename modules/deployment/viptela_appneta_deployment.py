        ...
        for server_ip in server_ips:
            ...
            if matching_nodes:
                for matching_node in matching_nodes:
                    ...
                    appneta_cli_curl_commands(server_ip, server_name, project_name, deployment_type, console_port, node_name[0], appneta_mp_mac, mp_ip_address, appn_site_key, appn_url)
                    v += 1
