                ...
                for matching_node in matching_nodes:
                    ...
                    for flexvnf_lan_object in flexvnf_lan_objects:
                        if flexvnf_lan_object['flexvnf'] == temp_node_name:
                            ...
                            lan_router_address = flexvnf_lan_object['router_address']
                    ...
                    versa_create_site_device_workflow(versa_director_mgmt_ip, vr_1_route_ip, lan_router_address, flexvnf_hostname, site_id, device_serial_number, flexvnf_country, flexvnf_city, vpn_0_ge0_0_ip_address, vpn_0_ge0_0_ip_gateway, vpn_0_ge0_1_ip_address, vpn_0_ge0_1_ip_gateway, tvi_0_2_ip, tvi_0_3_ip, latitude, longitude)
                    time.sleep(10)
