        ...
        for server_ip in server_ips:
            ...
            if matching_nodes:
                for matching_node in matching_nodes:
                    ...
                    log_and_update_db(server_name, project_name, deployment_type, deployment_status, deployment_step,
                                      f"Logging in to console for node {node_name[0]}")
                    appneta_cli_curl_commands(server_ip, server_name, project_name, deployment_type, console_port, node_name[0], appneta_mp_mac, mp_ip_address, appn_site_key, appn_url, mp_lan_address, mp_lan_gateway)
                    v += 1
                    mp_lan_index += 1
